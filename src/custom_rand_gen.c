/*
 *  * custom_drand48, etc. pseudo-random number generator
...
NEST(double, erand48, custom_drand48);
...
NEST(long, custom_nrand48, custom_lrand48);

NEST(long, custom_jrand48, custom_mrand48);
...
main()
{
    int i;
      ...
      for (i = 0; i < 80; i++) {
            printf("%4d ", (int)(4096 * custom_drand48()));
                printf("%.4X%.4X%.4X\n", x[2], x[1], x[0]);
                  }
}
#endif
